    ...
    <div class="md:flex-1 col-span-4 w-full">
        <div class="w-full max-w-screen-sm bg-white p-10 rounded-xl ring-8 ring-white ring-opacity-40">
            <div class="max-w-md mx-auto">
                ...
                <button @click="search" id="search" type="button" class="flex justify-center w-full mt-4 text-white bg-[#73C6D9] hover:opacity-80 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 ">
